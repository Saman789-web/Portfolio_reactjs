            ...
            <div className="flex gap-3 py-4">
              ...
              <span className="w-96 ">
                ...
                <p className="text-sm md:text-md leading-tight">
                  ...
                  similique officia voluptas magnam quasi? Possimus error
                  libero, minus excepturi dignissimos laborum facere perferendis
                  reprehenderit rem nemo sapiente saepe et cumque.
                </p>
              </span>
            </div>
            <div className="flex gap-3 py-4">
